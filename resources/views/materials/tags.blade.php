...
@section('content')
    ...
    <br>
    <a href = "/materials/tags/{!!$choosentopic_slug!!}"><span class = "badge badge-secondary">{{$choosentopic_title}}</span></a>
    <a href = "/materials/">back</a>
    <br>
    @if(count($materials) > 0)
        <br><br>
        {!! Form::open(['action' => ['MaterialController@tags',$choosentopic_slug],'method' => 'GET']) !!}
        <div class = "row">
            <div class = "col-5">
